    ...
    function () {
	 ...
	 <html lang="en">
	   <head>
		 ...
		 <script src="typerwrite.js"></script>
		 <div id="particles-js">
		   <header>
			 <h1>
			   <br />
	 ...
	 */
	 ...
	 `;
      ...
      fs.writeFile(path.join(folderPath, "index.html"), HTMLContent, (err) => {
        if (err) {
          console.log(err);
          vscode.window.showErrorMessage("Failed to create the HTML File");
        }
        vscode.window.showInformationMessage("Created the HTML File");
      });
      fs.writeFile(path.join(folderPath, "app.js"), JSContent, (err) => {
        ...
        vscode.window.showInformationMessage("Created the App JS");
      });
      fs.writeFile(path.join(folderPath, "particles.js"), particleJS, (err) => {
        if (err) {
          console.log(err);
          vscode.window.showErrorMessage("Failed to create Particle JS");
        }
        vscode.window.showInformationMessage("Created the Particle JS");
      });
      fs.writeFile(path.join(folderPath, "style.css"), CSSContent, (err) => {
        ...
        vscode.window.showInformationMessage("Created the Style CSS");
      });
    }
  );
